...
/**
 * This is the model base class for the table "cross_reference".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "CrossReference".
 *
 * Columns in table "cross_reference" available as properties of the model,
 * followed by relations of table "cross_reference" available as properties of the model.
 *
...
abstract class BaseCrossReference extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('name, accession, identifier', 'length', 'max'=>15),
