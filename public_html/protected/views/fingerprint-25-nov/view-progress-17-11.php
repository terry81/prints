...
<table class="table">
<col width="50"><col width="50"><col width="800">
...
<?php
    ...
    if (!empty($tpp_array)) {
        ...
        echo '<table style="table"><col width="50"><col width="50"><col width="50"><col width="800"><tr><th>Protein ID code</th><th>Accession number</th><th>Number of motifs</th><th>Description</th></tr>';
        arsort($tpp_array);
