...
; ?>
		...
		<div class="row">
		<?php echo $form->labelEx($model,'cfi'); ?>
		<?php echo $form->textArea($model, 'cfi'); ?>
		<?php echo $form->error($model,'cfi'); ?>
		</div><!-- row -->
		<div class="row">
		...
		<label><?php echo GxHtml::encode($model->getRelationLabel('scanhistories')); ?></label>
		<?php echo $form->checkBoxList($model, 'scanhistories', GxHtml::encodeEx(GxHtml::listDataEx(Scanhistory::model()->findAllAttributes(null, true)), false, true)); ?>
		...
		<label><?php echo GxHtml::encode($model->getRelationLabel('proteins')); ?></label>
