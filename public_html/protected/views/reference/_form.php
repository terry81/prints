...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->textField($model, 'author', array('maxlength' => 1500)); ?>
		<?php echo $form->error($model,'author'); ?>
		</div><!-- row -->
		<div class="row">
		<?php echo $form->labelEx($model,'title'); ?>
		<?php echo $form->textField($model, 'title', array('maxlength' => 1000)); ?>
		<?php echo $form->error($model,'title'); ?>
		</div><!-- row -->
		<div class="row">
		<?php echo $form->labelEx($model,'journal'); ?>
		<?php echo $form->textField($model, 'journal', array('maxlength' => 200)); ?>
