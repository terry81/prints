...
<h2><?php echo GxHtml::encode($model->getRelationLabel('seqs')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->seqs as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('seq/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
